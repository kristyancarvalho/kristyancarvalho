...
var sources = []sourceSpec{
	...
	simpleIcon("qt", "Qt", "qt"),
	simpleIcon("java", "OpenJDK", "openjdk"),
	simpleIcon("python", "Python", "python"),
	simpleIcon("rust", "Rust", "rust"),
	devicon("c", "C", "c/c-original.svg"),
	devicon("c++", "C++", "cplusplus/cplusplus-plain.svg"),
}
